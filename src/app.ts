...
class ProjectInput {
  ...
  constructor() {
    ...
    // TODO: access to different inputs in the form (this.element)
  ...
  private gatherUserInput(): [string, string, number] | void {
    ...
    // TODO: change it to re-usable validation
    // if (
